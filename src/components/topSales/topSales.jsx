...
const TopSales = () => {
    ...
    return productJSON.products.map((index) => (
        <div className={classes.wrapper} key={index.id} index={index}>
            <div className={classes.main_cart_wrap}>
                ...
                <div className={classes.price_box}>
                    <span className={classes.prevPrice}>{index.price}c.</span>
                ...
                <div className={classes.main__colorsDiv}>
                    <span className={classes.main__colorsHover}>
                        <span
                            ...
                            style={{ background: index.colors[0].slug }}
                        ></span>
                    </span>
                </div>
                {/* <ColorSelection product={product} setProduct={setProduct} /> */}
            </div>
        </div>
    ));
};
