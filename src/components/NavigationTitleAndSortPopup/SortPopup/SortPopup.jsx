...
const SortPopup = ({ item }) => {
  ...
  return (
    <div ref={sortRef} className={classes.sort}>
      ...
      <div className={visiblePopup ? classes.sort__sort_wrap__popup : classes.sort__sort_wrap}>

        <div onClick={toggleVisible} className={visiblePopup ? classes.sort__sort_wrap__open_links : classes.sort__sort_wrap__close_links}>
