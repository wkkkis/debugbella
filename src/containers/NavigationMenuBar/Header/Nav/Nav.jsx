    ...
    <div className={classes.Nav}>
      <ul className={classes.ul}>
        ...
        <div className={classes.right}>
          ...
          <span style={{cursor:"pointer" , display:"felx" , alignItems:"center"}}>
            <div>
              <div className={classes.cont} style={{ position: "realtive" , marginRight:"0"}}>
                ...
                <>
                  ...
                  >
                    <span className={classes.link}>
                      <Link to="/product">мои заказы</Link>
                    </span>
                    <span className={classes.link}>
